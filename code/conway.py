...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 18:40:48 2018
      ...
      for x in [i-1, i, i+1]:
         for y in [j-1, j, j+1]:
            ...
            # In this case, we loop back round such that the grid becomes a "toroidal array".
               ...
               s += self.old_grid[0][0]
      return s
      #Idee: Gebe einen "gewichteten" Wert der "lebenden Zellen" zurück. Z.B. soll eine nahestehende lebende Zelle als 2 Zellen zählen.
